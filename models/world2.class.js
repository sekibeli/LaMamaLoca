class World {
    ...
    checkIfFireballCollidesWithEndboss() {
        ...
        // console.log(this.activeFireball.x , world.level.endboss.x - 570 , this.activeFireball.y , world.level.endboss.y + 300);
        // console.log(this.activeFireball.x > world.level.endboss.x - 570 && this.activeFireball.y < world.level.endboss.y + 300);
        // console.log(this.activeFireball.x > world.level.endboss.x - 300 && this.activeFireball.y < world.level.endboss.y + 300);
        ...
        // if (this.activeFireball.x > world.level.endboss.x - 570 && this.activeFireball.y < world.level.endboss.y + 300 && !this.level.endboss.dead && this.level.endboss.energy > 0 && !this.level.endboss.endboss_invulnerable) {
       
    //    console.log('Endboss collision with fireball: ', this.activeFireball.isCollidingWith(world.level.endboss));
    //    console.log('Abstand Character zu Endboss < 1000: ',  (Math.abs(world.level.endboss.x + world.level.endboss.offset.left - this.character.x + this.character.width - this.character.offset.right) < 1000) );
    //    console.log('Endboss nicht tot: ',  !this.level.endboss.dead);
    //    console.log('Endboss Energy > 0: ', this.level.endboss.energy > 0);
    //    console.log('Endboss nicht unverwundbar: ', !this.level.endboss.endboss_invulnerable);
       
        if (this.activeFireball.isCollidingWith(world.level.endboss) &&
            (Math.abs(world.level.endboss.x + world.level.endboss.offset.left - this.character.x + this.character.width - this.character.offset.right) < 1000) &&
            !this.level.endboss.dead && this.level.endboss.energy > 0 && !this.level.endboss.endboss_invulnerable) {

              
            console.log('Fireball hits endboss');
            world.activeFireball.fireballExplosion();
